...
const [alert, setAlert] = useState({
  ...
  <MdAbc size={30} color='grey' />
          ...
          <div className="mb-6 w-[100%] flex flex-col gap-2">
            <label className="block text-sm font-medium mb-3">Starting date</label>
          ...
          <div className="mb-6 w-[100%] flex flex-col gap-2">
            <label className="block text-sm font-medium mb-3">Ending date</label>
      ...
      >
        <label className="block text-sm font-medium">
          {isExpanded ? <FaPlus className='pb-1' size={20} /> : <IoRemove className='pb-1' size={20} />}
        </label>
      </div>
    </div>
            <p className="text-sm text-gray-500 mt-1">
  ...
  <TiArrowRepeat size={24} color='grey' />
          ...
          </div><div className="mb-6 w-[100%] flex flex-col gap-2">
          ...
          >
            <div className={`w-5 h-5 rounded-full border-2 ${
              alert.severity === option.value 
                ? `${option.color} border-${option.color.split('-')[1]}-700`
                : 'border-gray-300'
